      ...
      <div className="container mx-auto px-4">
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="pt-8">
            ...
            <input
              type="text"
              className="w-full h-12 border mt-2 rounded-md mb-6 pl-2"
              aria-label="Username"
            />
          </div>
          ...
          <div className="pt-4">
            ...
            <input
              type="password"
              className="w-full h-12 border mt-2 rounded-md mb-10 pl-2"
              aria-label="Password"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full h-12 bg-[#9900FF] rounded-full text-white hover:bg-[#9900CC] transition-colors"
