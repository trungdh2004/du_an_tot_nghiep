...
const Vorcher = () => {
	return (
		<div className="py-2">
			<div className="flex lg:flex-row gap-3 items-center bg-white justify-between py-2 border border-gray-200">
				...
				<div className="flex text-center pr-4 gap-2 items-center">
					...
					<Input placeholder="Mã giảm giá" className="border border-blue-200 ld:text-base text-sm"  />
				</div>
			</div>
		</div>
	);
