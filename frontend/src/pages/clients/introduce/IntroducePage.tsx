...
const IntroducePage = () => {
	...
	return (
		<div className="px-0 sm:px-[30px] md:px-[62px] w-full">
			<h1 className="text-center pt-8 text-[18px]">VỀ CHÚNG TÔI</h1>
			<h2 className="text-center text-[22px] pt-1 pb-8">
				THƯƠNG HIỆU THỜI TRANG NUCSHOP
			</h2>
			<div className="flex flex-col md:flex-row justify-between">
				<p className="w-full md:w-[38%] md:ml-28 text-[16px] text-[#544e46]">
				...
				<p className="w-full md:w-[38%] md:mr-28 text-[16px] text-[#544e46] mt-4 md:mt-0">
			...
			<div className="flex flex-col md:flex-row pt-14 justify-between">
				<img
					...
					alt=""
					className="w-full md:w-[670px] transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:rounded-lg"
				/>
				<div className="mt-8 md:mt-0 md:mr-28">
					<h3 className="text-center pt-16 font-sans text-[18px]">NUCSHOP</h3>
					<h2 className="text-center font-serif text-[22px] pt-1 pb-8">
						CÂU CHUYỆN THƯƠNG HIỆU
					</h2>
					<p className="w-full md:w-[500px] text-[16px] text-[#544e46]">
						NUCSHOP không chỉ là một thương hiệu thời trang, mà là kết quả của niềm
						...
						trang, NUCSHOP đã trải qua một hành trình đầy thử thách và cảm hứng. Theo
						thời gian, NUCSHOP dần mở rộng và phát triển với nhiều bộ sưu tập đa
			...
			<div className="flex flex-col md:flex-row pt-20 justify-between mb-10">
				<div className="pt-10 md:ml-20">
					...
					<p className="w-full md:w-[500px] text-[16px] text-[#544e46]">
						...
						đảm bảo sự thoải mái, bền bỉ và đẹp mắt cho người mặc. NUCSHOP không ngừng
				...
				<img
					className="w-full md:w-[720px] transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:rounded-lg mt-8 md:mt-0"
